...
const en = {
  ...
  'personality.lazy.desc': 'Goes on strike more often (+10%), but sleeping cheers it up more.',
  'personality.glutton.desc': 'Gets more nutrition from food, but gains weight fast and gets hungry sooner.',
  'personality.cuddly.desc': 'Loves cuddles (more happiness), but food & play cheer it up less.',
  'personality.playful.desc': 'Play charges refill faster & wins feel great, but it gets hungry sooner.',
  'personality.messy.desc': 'Gets dirty & poops more, but being dirty never bothers it.',
  'personality.sleepyhead.desc': 'Sleep restores more HP & stamina, but training tires it more.',
  ...
  'shop.partswap': 'Gene Splicer',
  'shop.partswapDesc': 'Reroll one body part to a random new look',
  'shop.partswapPick': '🧬 Pick a part to reroll',
  'shop.partswapped': "{name}'s {part} changed!",
  'part.body': 'Body', 'part.eyes': 'Eyes', 'part.mouth': 'Mouth', 'part.ears': 'Ears',
  'part.horn': 'Horns', 'part.nose': 'Nose', 'part.cheeks': 'Cheeks', 'part.tail': 'Tail', 'part.pattern': 'Pattern',
  ...
  'toast.exStrike': '{name} is bored of {ex}! No {ex} for {time} — mix it up.',
  'toast.tooSad': '{name} is too unhappy 😔 — cheer it up first.',
  'toast.tooSick': '{name} is too sick 🤒 — heal it first.',
  ...
  'menu.back': '⬅ Back',
  'album.title': 'Album',
  'album.subtitle': "Your pet's growth stages",
  'menu.league': '🏆 Championship',
  'league.title': 'Championship',
  'league.subtitle': 'Climb the leagues',
  'league.bronze': 'Bronze League', 'league.silver': 'Silver League', 'league.gold': 'Gold League',
  'league.platinum': 'Platinum League', 'league.diamond': 'Diamond League',
  'league.progress': 'Opponent {cur}/{total}',
  'league.fight': '⚔️ Challenge',
  'league.won': '{name} won the match!',
  'league.promoted': '{name} was promoted to the {league}!',
  'league.champion': '{name} is the CHAMPION! 🏆',
  'league.championTitle': '🏆 Champion of every league!',
  'league.alreadyChampion': '{name} already conquered every league!',
  'league.unavailable': 'Championship unavailable right now.',
...
const it = {
  ...
  'personality.lazy.desc': 'Va in sciopero più spesso (+10%), ma dormire lo rende più felice.',
  'personality.glutton.desc': 'Ricava più nutrimento dal cibo, ma ingrassa in fretta e ha fame prima.',
  'personality.cuddly.desc': 'Adora le coccole (più felicità), ma cibo e gioco lo rallegrano meno.',
  'personality.playful.desc': 'Ricarica il gioco più in fretta e gode delle vittorie, ma ha fame prima.',
  'personality.messy.desc': 'Si sporca e caga di più, ma lo sporco non gli dà fastidio.',
  'personality.sleepyhead.desc': 'Dormendo recupera più HP e stamina, ma l\'allenamento lo stanca di più.',
  ...
  'shop.partswap': 'Splicer Genetico',
  'shop.partswapDesc': 'Rigenera una parte del corpo in un aspetto casuale nuovo',
  'shop.partswapPick': '🧬 Scegli la parte da rigenerare',
  'shop.partswapped': '{part} di {name} è cambiato!',
  'part.body': 'Corpo', 'part.eyes': 'Occhi', 'part.mouth': 'Bocca', 'part.ears': 'Orecchie',
  'part.horn': 'Corna', 'part.nose': 'Naso', 'part.cheeks': 'Guance', 'part.tail': 'Coda', 'part.pattern': 'Motivo',
  ...
  'toast.exStrike': '{name} è stufo di {ex}! Niente {ex} per {time} — cambia esercizio.',
  'toast.tooSad': '{name} è troppo giù 😔 — tiralo su prima.',
  'toast.tooSick': '{name} sta troppo male 🤒 — curalo prima.',
  ...
  'menu.back': '⬅ Indietro',
  'album.title': 'Album',
  'album.subtitle': 'Gli stadi di crescita del tuo pet',
  'menu.league': '🏆 Campionato',
  'league.title': 'Campionato',
  'league.subtitle': 'Scala le leghe',
  'league.bronze': 'Lega Bronzo', 'league.silver': 'Lega Argento', 'league.gold': 'Lega Oro',
  'league.platinum': 'Lega Platino', 'league.diamond': 'Lega Diamante',
  'league.progress': 'Avversario {cur}/{total}',
  'league.fight': '⚔️ Sfida',
  'league.won': '{name} ha vinto l\'incontro!',
  'league.promoted': '{name} è stato promosso in {league}!',
  'league.champion': '{name} è il CAMPIONE! 🏆',
  'league.championTitle': '🏆 Campione di tutte le leghe!',
  'league.alreadyChampion': '{name} ha già conquistato tutte le leghe!',
  'league.unavailable': 'Campionato non disponibile ora.',
...
const ja = {
  ...
  'personality.lazy.desc': 'ストライキ しやすい（+10%）が、すいみんで きげんが よくなる。',
  'personality.glutton.desc': 'たべものから えいようを おおく とるが、ふとりやすく はやく おなかがすく。',
  'personality.cuddly.desc': 'だっこ だいすき（こうふく＋）だが、ごはん と あそびでは よろこびにくい。',
  'personality.playful.desc': 'あそびチャージが はやく、しょうりが うれしいが、はやく おなかがすく。',
  'personality.messy.desc': 'よごれ・うんちが おおいが、よごれても へいき。',
  'personality.sleepyhead.desc': 'すいみんで HP と スタミナを おおく かいふく、でも トレーニングで つかれやすい。',
  ...
  'shop.partswap': 'いでんし スプライサー',
  'shop.partswapDesc': 'からだの パーツを ひとつ ランダムに ふりなおす',
  'shop.partswapPick': '🧬 ふりなおす パーツを えらんで',
  'shop.partswapped': '{name} の {part} が かわった！',
  'part.body': 'からだ', 'part.eyes': 'め', 'part.mouth': 'くち', 'part.ears': 'みみ',
  'part.horn': 'つの', 'part.nose': 'はな', 'part.cheeks': 'ほっぺ', 'part.tail': 'しっぽ', 'part.pattern': 'もよう',
  ...
  'toast.exStrike': '{name} は {ex} に あきちゃった！あと {time} は {ex} できない——べつのを。',
  'toast.tooSad': '{name} は げんきがない 😔 — さきに きげんを なおそう。',
  'toast.tooSick': '{name} は ぐあいが わるい 🤒 — さきに なおそう。',
  ...
  'menu.back': '⬅ もどる',
  'album.title': 'アルバム',
  'album.subtitle': 'ペットの せいちょう だんかい',
  'menu.league': '🏆 チャンピオンシップ',
  'league.title': 'チャンピオンシップ',
  'league.subtitle': 'リーグを のぼろう',
  'league.bronze': 'ブロンズリーグ', 'league.silver': 'シルバーリーグ', 'league.gold': 'ゴールドリーグ',
  'league.platinum': 'プラチナリーグ', 'league.diamond': 'ダイヤリーグ',
  'league.progress': 'あいて {cur}/{total}',
  'league.fight': '⚔️ ちょうせん',
  'league.won': '{name} は しあいに かった！',
  'league.promoted': '{name} は {league} に しょうかく！',
  'league.champion': '{name} は チャンピオン！🏆',
  'league.championTitle': '🏆 ぜんリーグ せいは！',
  'league.alreadyChampion': '{name} は もう ぜんリーグを せいはした！',
  'league.unavailable': 'いまは チャンピオンシップを りようできません。',
